...
6x((-2)x7-5x7)-1x(4x7-5x2)-1x(4x8-(-2)x2) = 6x(-49)-1x(18)-1x(52) = -294-6-52 = -364

2. 
$$F = \begin{pmatrix} 0 & 9 & -4 \\ 5 & 3 & 2 \\ 1 & 0 & 8 \end{pmatrix}$$
0x(3x8-2x0)-9x(5x8-2x1)-(-4)x(5x0-3x1) = 0-9x(38)-(-4)x(-3) = 0-342+12 = -330

3. 
$$G = \begin{pmatrix} 7 & 3 & 1 \\ 2 & 6 & 4 \\ 0 & 2 & 8 \end{pmatrix}$$
7x(6x8-4x2)-3x(2x8-4x0)-1x(2x2-6x0) = 7x40-3x12-1x4 = 280-36-4 = 240
